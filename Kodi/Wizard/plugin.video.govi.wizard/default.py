...
ADDON=xbmcaddon.Addon(id='plugin.video.govi.wizard')
...
def wizard(name,url,description):
    ...
    dp.create("[COLOR=orange]GoVi Wizard[/COLOR]","[COLOR=orange]DOWNLOADING[/COLOR]",'', '[COLOR=orange]Please Wait[/COLOR]')
